...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post tareas_url, params: { tarea: { barrio: @tarea.barrio, cuidad: @tarea.cuidad, departamento: @tarea.departamento, estado: @tarea.estado, fecha: @tarea.fecha, titulo: @tarea.titulo, user: @tarea.user } }
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { barrio: @tarea.barrio, cuidad: @tarea.cuidad, departamento: @tarea.departamento, estado: @tarea.estado, fecha: @tarea.fecha, titulo: @tarea.titulo, user: @tarea.user } }
